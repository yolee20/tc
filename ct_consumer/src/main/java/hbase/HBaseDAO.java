...
public class HBaseDAO {
    ...
    public void put(String ori) {
        try {
            ...
            String buildTimeLong = String.valueOf(sdf1.parse(buildTime).getTime());
            ...
            put.addColumn(Bytes.toBytes("f1"), Bytes.toBytes("build_time_long"), Bytes.toBytes(buildTimeLong));
